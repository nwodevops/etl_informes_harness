...
`sources: []` → no-op (smoke del cascarón; queda `DEMO_TABLA_EJEMPLO`).
...
| Excel | `STG_XLS_` o el prefijo que acuerdes |
...
- Escritura demo: `python/io/escribir_excel.py` → `output/resultado.xlsx`
